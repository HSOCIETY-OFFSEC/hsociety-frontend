                  ...
                  <div key={item.id} className="path-item">
                    <div className="path-info">
                      ...
                      <span className={`path-status ${item.status}`}>
                        {item.status === 'done' ? 'Completed' : item.status === 'in-progress' ? 'In Progress' : 'Next Up'}
                      </span>
                    </div>
                  ...
                  return (
                    <div key={challenge.id} className="lab-item">
                      ...
                      <div>
                        ...
                        <span>{challenge.level} · {challenge.time}</span>
                      </div>
                      <Button variant="ghost" size="small">Launch</Button>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="mentor-list">
                {data.mentors.map((mentor, index) => (
                  <div key={mentor.id} className="mentor-row">
                    ...
                    <span className={`mentor-status ${mentor.status === 'Available' ? 'online' : 'busy'}`}>
                      {mentor.status}
                    </span>
                  </div>
                ))}
              </div>
              <Button variant="secondary" size="small">Book a Session</Button>
            </Card>
          </div>
        )}
